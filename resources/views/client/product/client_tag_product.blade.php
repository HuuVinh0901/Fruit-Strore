        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mt-3">
                    ...
                    <div class="row" style="margin-top: 25px; margin-bottom: 30px">
                        <form action="">
                            ...
                            <div class="row">
                                <input type="text" id="amount_min_tag" class="col-4 ml-3" readonly style="border:0; color:#f6931f; font-weight:bold;">
                                <input type="text" id="amount_max_tag" class="col-4" readonly style="border:0; color:#f6931f; font-weight: bold; text-align:center; margin-left: 82px">
                            </div>
                            <div id="slider-range-tag" style="width: 238px" class="ml-4"></div>
                            <input type="hidden" id="min_amount_tag" name="min_amount_tag">
                            <input type="hidden" id="max_amount_tag" name="max_amount_tag">
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-9 mt-2">
                    ...
                    <h5 class="col-md mb-4 mt-2 text-center" style="text-transform: uppercase"><b>TỪ KHÓA TÌM KIẾM {{$product_tag}}</b> </h5>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-6 col-12 row">
                    @foreach ($list_product_tag as $key => $show_product)
                    ...
                    <span style="margin-left: 12px">
                        {{ $list_product_tag->links('pagination::bootstrap-4') }}
                    </span>
                </div>
            </div>
