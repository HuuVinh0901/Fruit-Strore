        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mt-3">
                    ...
                    <div class="row" style="margin-top: 25px; margin-bottom: 30px">
                        <form action="">
                            ...
                            <div class="row">
                                <input type="text" id="amount_min_origin" class="col-4 ml-3" readonly style="border:0; color:#f6931f; font-weight:bold;">
                                <input type="text" id="amount_max_origin" class="col-4" readonly style="border:0; color:#f6931f; font-weight: bold; text-align:center; margin-left: 82px">
                            </div>
                            <div id="slider-range-origin" style="width: 238px" class="ml-4"></div>
                            <input type="hidden" id="min_amount_origin" name="min_amount_origin">
                            <input type="hidden" id="max_amount_origin" name="max_amount_origin">
                        </form>
                    </div>
                </div>
                {{-- Tìm kiếm --}}
                <div class="col-md-9 mt-2">
                    ...
                    @foreach ($name_origin as $key => $show_name)
                    <h5 class="mb-4 mt-2 text-center" style="text-transform: uppercase;"><b> DANH SÁCH TRÁI CÂY NHẬP KHẨU TỪ
                        {{ $show_name->origin_name }}</b></h5>
                    @endforeach
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-6 col-12 row">
                    @foreach ($id_origin as $key => $show_product)
                    ...
                    <span style="margin-left: 12px;">
                        {{ $id_origin->links('pagination::bootstrap-4') }}
                    </span>
                </div>
            </div>
