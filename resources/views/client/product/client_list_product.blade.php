        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mt-3">
                        ...
                        <form>
                            ...
                            <div class="sidebar ftco-animate">
                                <div style="font-size: 15px; background-color: #82AE46; color:#fff" class="card-header">
                                    <span>Xếp theo:</span>
                                    <select name="client_sort_product" id="client_sort_product" style="width: 145px; background-color: #82AE46; color:#fff; border:#82AE46">
                    ...
                    <div class="row" style="margin-top: 25px; margin-bottom: 30px">
                        <form action="">
                            ...
                            <div class="row">
                                <input type="text" id="amount_min" class="col-4 ml-3" readonly style="border:0; color:#f6931f; font-weight:bold;">
                                <input type="text" id="amount_max" class="col-4" readonly style="border:0; color:#f6931f; font-weight: bold; text-align:center; margin-left: 82px">
                            </div>
                            <div id="slider-range" style="width: 238px" class="ml-4"></div>
                ...
                <div class="col-md-9 mt-2">
                    ...
                    <h5 class="col-md mb-4 mt-2 text-center" style="text-transform: uppercase;"><b>DANH SÁCH TRÁI CÂY NHẬP KHẨU</b> </h5>
                </div>
            </div>
