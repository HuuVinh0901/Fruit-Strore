        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12">
                    @foreach ($price as $key => $show_name)
                        <h5 class="col-md mb-4 mt-2 text-center" style="text-transform: uppercase"><b>DANH SÁCH TRÁI CÂY NHẬP KHẨU CÓ GIÁ
                        {{ number_format($show_name->product_price,0,'.','.') }}</b></h5>
                    @endforeach
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-6 col-12 row">
                    @foreach ($price_product as $key => $show_product)
                    ...
                    <span style="margin-left: 12px">
                        {{ $price_product->links('pagination::bootstrap-4') }}
                    </span>
                </div>
            </div>
