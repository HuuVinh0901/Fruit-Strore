                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form action="{{URL::to('admin_login_home_dashboard')}}" method="POST">
                                        {{-- trường này gửi bảo mật hơn --}}
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <label><strong>Email</strong></label>
                                            <input type="email" name="admin_email" class="form-control" value="hello@example.com">
                                        </div>
                                        <div class="form-group">
                                            <label><strong>Password</strong></label>
                                            <input type="password" name="admin_password" class="form-control" value="Password">
                                        </div>
