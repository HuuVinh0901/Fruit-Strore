...
<head>
    ...
    <title>Shipper ImportedFruit</title>
    <!-- Favicon icon -->
                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <h4 class="text-center mb-4">ĐĂNG NHẬP NHÂN VIÊN GIAO HÀNG</h4>
                                    ...
                                    <form action="{{URL::to('admin_submit_login_shipper')}}" method="POST">
                                        {{-- trường này gửi bảo mật hơn --}}
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <label><strong>Email</strong></label>
                                            <input type="email" name="email_admin" class="form-control" value="">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="new-account mt-3">
                                        <p><a style="color: #6EAA3F" href="{{URL::to('/admin_login_staff')}}"><b>Đăng nhập </b></a>bằng tài khoản nhân viên bán hàng?</p>
